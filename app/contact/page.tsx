...
export const metadata: Metadata = {
  title:
    "Contacto - Peak Motion",
  description:
    "Contáctanos para discutir tu proyecto de trail running. Producción audiovisual cinematográfica y branding para atletas y eventos.",
};
              ...
              <VelocityMarquee className="marquee marquee-right--gsap muted-extra">
                <div className="marquee__toright">
                  ...
                  {Array.from({ length: 4 }).map((_, idx) => (
                    ...
                    >
                      <p className="marquee__text">Conecta</p>
