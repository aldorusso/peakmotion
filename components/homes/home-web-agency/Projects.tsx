              ...
              >
                        ...
                        <div className="col-12">
                          <div className="mxd-section-title__descr">
                            <p className="anim-uni-in-up">
                              Explora una selección de proyectos que fusionan
                              <br />
                              creatividad cinematográfica y compromiso real
                            </p>
                          </div>
                        </div>
                        <div className="col-12">
                ...
                {projects1.slice(0, 6).map((project, index) => (
                  ...
                  >
                    ...
                    >
                      <div className="mxd-project-item__preview masonry-preview parallax-img-small" style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
                        <Image
                    ...
                    <g>
                      ...
                      <text>
                        ...
                        <textPath xlinkHref="#textPath">
                          Empecemos tu proyecto * Empecemos tu proyecto *
                        </textPath>
                      </text>
                    </g>
                  </AnimateRotation>
