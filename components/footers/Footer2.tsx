        ...
        <div className="footer-blocks__column animate-card-3">
          ...
          <div className="footer-blocks__card">
            ...
            c0,0,1.3-0.1,1.8-0.2c1,0,4,0,4,0c0.2,0,0.4-0.2,0.4-0.4C20,9.8,19.8,9.6,19.6,9.6L19.6,9.6z"
              ...
              <a href="mailto:info@peakmotion.es?subject=Mensaje%20desde%20Peak%20Motion">
                info@peakmotion.es
              </a>
            </p>
          </div>
          ...
          <div className="footer-blocks__card">
            ...
            c0,0,1.3-0.1,1.8-0.2c1,0,4,0,4,0c0.2,0,0.4-0.2,0.4-0.4C20,9.8,19.8,9.6,19.6,9.6L19.6,9.6z"
              ...
              <a href="tel:+34633815083">+34 633 815 083</a> / <a href="tel:+34636499798">+34 636 499 798</a>
            </p>
          </div>
          {/* inner card */}
        ...
        <div className="footer-blocks__column animate-card-3">
          ...
          <div className="footer-blocks__card fullheight-card">
            ...
            <div className="footer-blocks__block">
              {/* card title */}
              <div className="footer-blocks__title anim-uni-in-up">
                <p className="footer-blocks__title-l">Síguenos</p>
              </div>
              {/* footer socials */}
