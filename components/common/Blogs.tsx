...
const defaultDesc = `Ideas inspiradoras, perspectivas creativas y lo último en trail running y mountain sports. Impulsando la innovación en tu viaje digital.`;
